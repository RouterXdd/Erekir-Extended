...
public class DirectShieldProjector extends Block{
    protected static final Vec2 intersectOut = new Vec2(), p1 = new Vec2(), p2 = new Vec2();
    protected static DirectShieldProjectorBuild paramEntity;
    ...
    public DirectShieldProjector(String name){
        super(name);
    ...
    public void setBars(){
        super.setBars();
        addBar("shield", (DirectShieldProjectorBuild entity) -> new Bar("stat.shieldhealth", Pal.accent, () -> entity.broken ? 0f : 1f - entity.buildup / (shieldHealth)).blink(Color.white));
    }
