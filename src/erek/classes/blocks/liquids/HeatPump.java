package erek.classes.blocks.liquids;
...
public class HeatPump extends Pump {
    ...
    public void setBars(){
        ...
        addBar("heat", (HeatPumpBuild entity) ->
                new Bar(() ->
    ...
    public class HeatPumpBuild extends PumpBuild implements HeatConsumer{
